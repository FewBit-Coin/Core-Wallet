...
"""Verify that starting fewbitd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fewbitd with -h for help text")
        ...
        self.log.info("Start fewbitd with -version for version information")

...
from test_framework.test_framework import FewBitTestFramework
...
class LLMQChainLocksTest(FewBitTestFramework):
    def set_test_params(self):
        self.set_fewbit_test_params(6, 5, fast_dip3_enforcement=True)

...
# Copyright (c) 2019 The FewBit developers
...
Arguments:
    <base_directory> - The base directory of a FewBit Core source code repository.
...
Arguments:
    <base_directory> - The base directory of FewBit Core source code repository.
"""
...
CPP_HEADER = '''
// Copyright (c) %s The FewBit developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The FewBit developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the FewBit Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The FewBit

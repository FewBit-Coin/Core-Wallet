...
rm -f src/config/fewbit-config.h
...
rm -rf test_bitcoin.coverage/ fewbit-gtest.coverage/ total.coverage/
...
clean_exe src/fewbit-cli
clean_exe src/fewbitd
clean_exe src/fewbit-gtest
clean_exe src/fewbit-tx
clean_exe src/test/test_fewbit
clean_exe src/test/test_fewbit_fuzzy
...
clean_dep . src/config/fewbit-config.h.in

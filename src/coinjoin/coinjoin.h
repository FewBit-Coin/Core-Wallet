...
public:
    ...
    static int GetMinPoolParticipants() { return sporkManager.IsSporkActive(SPORK_24_PS_MORE_PARTICIPANTS) ? Params().PoolNewMinParticipants() : Params().PoolMinParticipants(); }
    static int GetMaxPoolParticipants() { return sporkManager.IsSporkActive(SPORK_24_PS_MORE_PARTICIPANTS) ? Params().PoolNewMaxParticipants() : Params().PoolMaxParticipants(); }

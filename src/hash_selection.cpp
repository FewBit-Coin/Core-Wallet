/* Copyright (c) 2020 The FewBit Core developers
...
void cnHash(uint512* toHash, uint512* hash, int lenToHash, int hashSelection)
{
    ...
    switch (hashSelection) {
    case 0:
        crypto::cryptonight_dark_hash(input, output, lenToHash, 1);
        break;
    case 1:
        crypto::cryptonight_darklite_hash(input, output, lenToHash, 1);
        break;
    case 2:
        crypto::cryptonight_cnfast_hash(input, output, lenToHash, 1);
        break;
    case 3:

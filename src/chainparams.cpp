...
{
    const char* pszTimestamp = "FewBit commenced operations on May 15, 2024";
    const CScript genesisOutputScript = CScript() << ParseHex("042c52b2a6e56eef3ee88e97cb90e14b7b4567d54d74b3d4285a63a8d91f3083169bb06a180e9773e2d25737a245bb0747195dab9bb09ca19c0686107805744f26") << OP_CHECKSIG;
...
public:
    CMainParams()
    {
        ...
        consensus.BIP66Enabled = true; // 00000000000b1fa2dfa312863570e13fae9ca7b52744cb27e55422620b469aefa
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60;                                                       // FewBit: 1 day
        consensus.nPowTargetSpacing = 2 * 60;                                                              // FewBit: 2 minutes
        ...
        consensus.defaultAssumeValid = uint256S("ox6fb0b649723f51b67484019409fef94d077f17c8d88645e08c000b2e4fd3e28a"); // block hash for 0
        ...
        // FewBit script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 16);
        // FewBit private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 128);
        // FewBit BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // FewBit BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // FewBit BIP44 coin type is '5'
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60;                                                       // FewBit: 1 day
        consensus.nPowTargetSpacing = 60;                                                                  // FewBit: 1 minutes
        ...
        // Testnet FewBit script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);
        // Testnet FewBit BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet FewBit BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet FewBit BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        chainTxData = ChainTxData{
            1715727745, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,          // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CDevNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("fewbit.net",  "devnet-seed.fewbit.net"));

        // Testnet FewBit addresses start with 'e'
...
public:
    CRegTestParams()
    {
        ...
        // Regtest FewBit addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 140);
        // Regtest FewBit script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);
        // Regtest FewBit BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest FewBit BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest FewBit BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;

...
//! Interface for the src/evo part of a fewbit node (fewbitd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a fewbit node (fewbitd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a fewbit node (fewbitd process).
namespace Smartnode {
class Sync
{
public:
...
//! Top-level interface for a fewbit node (fewbitd process).
class Node
{
public:
    virtual ~Node() {}

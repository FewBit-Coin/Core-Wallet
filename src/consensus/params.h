...
// See https://github.com/fewbit/dips/blob/master/dip-0006.md for more details
struct LLMQParams {
    LLMQType type;
...
struct FutureRewardShare {
    ...
    float founder;
    FutureRewardShare() :
        smartnode(0), miner(0), founder(0) {}
    FutureRewardShare(float _smartnode, float _miner, float _founder) :
        smartnode(_smartnode), miner(_miner), founder(_founder) {}
};

...
#ifndef FEWBIT_CRYPTO_BLS_H
#define FEWBIT_CRYPTO_BLS_H
...
public:
    ...
    CBLSWrapper(const bool fLegacyIn = fLegacyDefault) :
        fLegacy(fLegacyIn)
    {
    }
    CBLSWrapper(const std::vector<unsigned char>& vecBytes, const bool fLegacyIn = fLegacyDefault) :

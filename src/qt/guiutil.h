...
/** Utility functions used by the FewBit Qt UI.
 */
namespace GUIUtil {
...
// Parse "fewbit:" URI into recipient object, return true on successful parsing
...
/** Load fewbit specific appliciation fonts */
bool loadFonts();
...
/** Check if a fewbit specific theme is activated (light/dark).*/

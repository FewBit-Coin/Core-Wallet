...
/* FewBitGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* FewBitGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "FewBit"
#define QAPP_ORG_DOMAIN "fewbit.com"
#define QAPP_APP_NAME_DEFAULT "FewBit-Qt"
#define QAPP_APP_NAME_TESTNET "FewBit-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "FewBit-Qt-%s"
#define QAPP_APP_NAME_REGTEST "FewBit-Qt-regtest"

    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about) {
        ...
        QString header = "Usage:\n"
                         "  fewbit-qt [command-line options]                     \n";
...
All the FewBit in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 FBIT, 0.01 FBIT, 0.1 FBIT, 1 FBIT and 10 FBIT -- sort of like the paper money you use every day.</li> \

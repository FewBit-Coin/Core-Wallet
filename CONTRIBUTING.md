# Contributing to FewBit Core

The FewBit Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/FewBit-Coin/Core-Wallet/blob/master/doc/translation_process.md)
...
The following applies to code changes to the FewBit Core project (and related
projects such as libsecp256k1), and is not to be confused with overall FewBit
Network Protocol consensus changes.

Whether a pull request is merged into FewBit Core rests with the project merge
...
Patches that change FewBit consensus rules are considerably more involved than
...
Where a patch set proposes to change the FewBit consensus, it must have been
...
The review process is normally fairly responsive on the FewBit Core repository, however
...
The project leader is the release manager for each FewBit Core release.

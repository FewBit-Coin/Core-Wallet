...
This document provides guidelines for internationalization of the FewBit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fewbit_en.ts` remains unchanged.
